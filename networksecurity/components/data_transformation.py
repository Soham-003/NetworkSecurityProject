...
class DataTransformation:
    ...
    def get_data_transformer_object(self, feature_columns):
        """
        This function creates preprocessing pipelines for numerical features.
        """
        try:
            # ✅ Numerical pipeline
            ...
            logging.info(f"Numerical columns: {feature_columns}")

            # ✅ Preprocessor with only numerical pipeline
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            # ✅ Step 5: Combine transformed features with target
